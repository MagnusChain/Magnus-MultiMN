...
function cmd_install() {
	...
	[[ ! $(grep "addnode=170.64.183.45" $new_folder/$COIN_CONFIG) ]] && echo "addnode=170.64.183.45" >> $new_folder/$COIN_CONFIG
...
function cmd_bootstrap() {
	...
	#For copied bootstrap data while new node installation // Ex. : multimn install magnus --bootstrap
...
function cmd_help() {
	echo -e "Options:\
			...
			\n**NOTE 2**: Check ${CYAN}https://github.com/MagnusChain/Magnus-MultiMN/wiki/Commands${NC} for extended info and usage examples of each command.\
			\n**NOTE 3**: Check ${CYAN}https://github.com/MagnusChain/Magnus-MultiMN/wiki/FAQs${NC} for technical questions and troubleshooting."
}
function cmd_update() {
	curl -sL https://raw.githubusercontent.com/MagnusChain/Magnus-MultiMN/master/multimn_install.sh 3>&3 | bash
	exit
}
